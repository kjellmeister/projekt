...
class CFormUserCreate extends CForm
{
  ...
  public function __construct($object)
  {
    ...
    $this->AddElement(new CFormElementText('acronym', array('required'=>true)))
         ->AddElement(new CFormElementPassword('password', array('required'=>true, 'label' => 'Password (must be longer than 4 characters):')))
    ...
    $this->SetValidation('acronym', array('not_empty'))
         ...
         ->SetValidation('password', array('password_length'))
         ->SetValidation('password1', array('password_length'))
